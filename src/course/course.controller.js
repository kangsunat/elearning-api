...
var CourseController = function () {
    ...
    var CourseController = _classThis = /** @class */ (function () {
        ...
        CourseController_1.prototype.create = function (createCourseDto) {
            return this.courseService.create(createCourseDto);
        };
        CourseController_1.prototype.findAll = function () {
            return this.courseService.findAll();
        };
        CourseController_1.prototype.findOne = function (id) {
            return this.courseService.findOne(+id);
        };
        CourseController_1.prototype.update = function (id, updateCourseDto) {
            return this.courseService.update(+id, updateCourseDto);
        };
        CourseController_1.prototype.remove = function (id) {
